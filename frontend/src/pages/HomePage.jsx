...
const categoryGradients = {
  Sedan: "linear-gradient(115deg, #0891b2 58%, #06b6d4 58%)",
  "Prime Sedan": "linear-gradient(115deg, #334155 58%, #475569 58%)",
  SUV: "linear-gradient(115deg, #dc2626 58%, #ef4444 58%)",
  "Prime SUV": "linear-gradient(115deg, #1e40af 58%, #2563eb 58%)",
  "Premium SUV": "linear-gradient(115deg, #7c3aed 58%, #8b5cf6 58%)",
  "Mini Bus": "linear-gradient(115deg, #059669 58%, #10b981 58%)",
};
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-up">
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed max-w-xl">
                Chennai's most reliable corporate cab service for MNCs. From
                sedans to mini buses, we provide end-to-end employee
                transportation solutions with 24/7 support.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/contact">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-gradient-to-r from-sky-500 to-teal-500 hover:from-sky-600 hover:to-teal-600 text-white px-8 btn-hover-scale"
                  >
                    Get a Quote
                ...
                <div className="flex items-center space-x-2">
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="w-8 h-8 rounded-full bg-gradient-to-br from-sky-400 to-teal-400 border-2 border-white flex items-center justify-center"
                      >
            ...
            >
              ...
              {/* Floating Card */}
              <div
                className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-4 animate-slide-in-left"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              Comprehensive transportation solutions tailored for modern
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              From compact sedans to spacious mini buses, choose the perfect
              vehicle for your corporate requirements.
            </p>
          </div>
            ...
            {fleet.slice(0, 3).map((vehicle) => (
              ...
              >
                <div
                  ...
                  style={{
                    background:
                      categoryGradients[vehicle.category] ||
                      "linear-gradient(115deg, #0891b2 58%, #06b6d4 58%)",
                  }}
                >
                  <img
                    src={vehicle.image}
      ...
      <section className="py-16 lg:py-20 bg-gradient-to-r from-sky-500 to-teal-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/90 text-lg mb-8">
            Get in touch with us today for a customized quote tailored to your
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-white text-sky-600 hover:bg-slate-50 px-8 btn-hover-scale"
              >
                Request a Quote
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            ...
            <a href={`tel:${companyInfo.mobile[0]}`}>
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto border-white text-white hover:bg-white/10 px-8"
              >
                Call Us Now
              </Button>
            </a>
